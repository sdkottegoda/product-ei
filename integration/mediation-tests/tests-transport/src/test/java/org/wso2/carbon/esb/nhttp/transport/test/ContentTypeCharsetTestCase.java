...
public class ContentTypeCharsetTestCase extends ESBNhttpIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        applyConfiguration(new File(
                getClass().getResource("/artifacts/ESB/nhttp/transport/contenttypecharset/axis2.xml").getPath()));
